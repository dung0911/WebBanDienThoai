    ...
    <?php foreach ($data as $row) { ?>
      <tr>
        ...
        <td><?php if ($row['TrangThai'] == 0) {
            ...
            ?></td>
        <td>
          <a href="?mod=hoadon&act=chitiet&id=<?= $row['MaHD'] ?>" class="btn btn-success">
            <i class="fa fa-eye"></i>
          </a>
          <a href="?mod=hoadon&act=delete&id=<?= $row['MaHD'] ?>" onclick="return confirm('Bạn có thật sự muốn xóa ?');" type="button" class="btn btn-danger">
